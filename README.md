...
<p style="text-align: left;">
  <a href="https://www.linkedin.com/in/arthur-resende-gomes-3312bb305" target="_blank" style="box-shadow: 4px 4px 10px rgba(0, 0, 0, 0.5); display: inline-block;">
...
<p style="text-align: left; padding: 20px">
  ...
  <img src="https://github.com/arthurresendes/assets/blob/main/alteryx-logo.jpeg?raw=true" height="40" width="40" alt="Alteryx" style="box-shadow: 4px 4px 10px rgba(0,0,0,0.5); margin: 5px; border-radius: 5px;" />
</a>
